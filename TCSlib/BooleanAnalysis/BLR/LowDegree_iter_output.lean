...
private lemma gowers_product_pm1_aux_h_lift_pm1 {n : Nat} (f : hypercube n → Bool) (x : BooleanAnalysis.BoolCube n) : lift_pm1 f x = 1 ∨ lift_pm1 f x = -1 := by
  exact by unfold lift_pm1; cases f x <;> tauto;
...
lemma gowers_product_pm1 (f : hypercube n → Bool) (k : ℕ)
  ...
  · exact (gowers_product_pm1_aux_h_lift_pm1 f) x;
...
private lemma degree_le_zero_iff_constant_aux_h_anon_1 {n : Nat} (f : hypercube n → Bool) (h : is_degree_le_bool f 0) (x y : hypercube n) : (gowers_product (lift_pm1 f) (0 + 1) x fun x_1 => xor_vec x y) = 1 :=
  h ( fun _ => xor_vec x y ) x

private lemma degree_le_zero_iff_constant_aux_h_eq_tail_h_anon_1 {n : Nat} (f : hypercube n → Bool) (h : is_degree_le_bool f 0) (x y : hypercube n) (h_anon_1 : (gowers_product (lift_pm1 f) (0 + 1) x fun x_1 => xor_vec x y) = 1) : f x = f (xor_vec x (xor_vec x y)) := by
  cases h : f x <;> cases h' : f ( xor_vec x ( xor_vec x y ) ) <;> simp_all +decide ;
  · unfold lift_pm1 at h_anon_1; simp_all +decide [ BoolToPM1 ] ;
    norm_num at h_anon_1;
  · unfold lift_pm1 at h_anon_1; simp_all +decide ;
    exact absurd h_anon_1 ( by norm_num );


private lemma degree_le_zero_iff_constant_aux_h_eq {n : Nat} (f : hypercube n → Bool) (h : is_degree_le_bool f 0) (x y : hypercube n) : f x = f (xor_vec x (xor_vec x y)) := by
  exact (degree_le_zero_iff_constant_aux_h_eq_tail_h_anon_1 f h x y ((degree_le_zero_iff_constant_aux_h_anon_1 f h x y)))
...
lemma degree_le_zero_iff_constant (f : hypercube n → Bool) :
  ...
  · intro h x y
    ...
    let h_eq : f x = f (xor_vec x (xor_vec x y)) := (degree_le_zero_iff_constant_aux_h_eq f h x y)
...
private lemma linear_is_degree_le_one_aux_h_simp__dup2 {n : Nat} {f : hypercube n → Bool} (hlin : is_linear_bool f) (a b : hypercube n) : lift_pm1 f (xor_vec a b) = lift_pm1 f a * lift_pm1 f b := by
  simp [lift_pm1];
  rw [ hlin a b, BoolToPM1_xor ];

private lemma linear_is_degree_le_one_aux_h_simp {n : Nat} {f : hypercube n → Bool} (hlin : is_linear_bool f) (hs : Fin (1 + 1) → hypercube n) (x : hypercube n) : lift_pm1 f (xor_vec x (hs 0)) = lift_pm1 f x * lift_pm1 f (hs 0) ∧ lift_pm1 f (xor_vec x (hs 1)) = lift_pm1 f x * lift_pm1 f (hs 1) ∧ lift_pm1 f (xor_vec (xor_vec x (hs 1)) (hs 0)) = lift_pm1 f x * lift_pm1 f (hs 1) * lift_pm1 f (hs 0) := by
  let h_simp__dup2 : ∀ a b : hypercube n, lift_pm1 f (xor_vec a b) = lift_pm1 f a * lift_pm1 f b := (linear_is_degree_le_one_aux_h_simp__dup2 hlin)
  aesop;
...
lemma linear_is_degree_le_one {f : hypercube n → Bool}
  ...
  rw [ (linear_is_degree_le_one_aux_h_simp hlin hs x).1, (linear_is_degree_le_one_aux_h_simp hlin hs x).2.1, (linear_is_degree_le_one_aux_h_simp hlin hs x).2.2 ] ; ring_nf;
  unfold lift_pm1;
  cases f x <;> cases f ( hs 0 ) <;> cases f ( hs 1 ) <;> norm_num [ BoolToPM1 ]

-- degree ≤ 1 functions are affine
private lemma degree_le_one_implies_affine_aux_h_anon_1 {n : Nat} {f : hypercube n → Bool} (hdeg : is_degree_le_bool f 1) (x h1 h2 : hypercube n) : gowers_product (lift_pm1 f) (1 + 1) x ![h1, h2] = 1 :=
  hdeg ( ![h1, h2] ) x

private lemma degree_le_one_implies_affine_aux_h_second_deriv_zero_tail_h_anon_1 {n : Nat} {f : hypercube n → Bool} (hdeg : is_degree_le_bool f 1) (x h1 h2 : hypercube n) (h_anon_1 : gowers_product (lift_pm1 f) (1 + 1) x ![h1, h2] = 1) : lift_pm1 f x * lift_pm1 f (xor_vec x h1) * lift_pm1 f (xor_vec x h2) * lift_pm1 f (xor_vec (xor_vec x h1) h2) = 1 := by
  simp_all +decide [ gowers_product_succ ];
  convert h_anon_1 using 1 ; ring_nf;
...
private lemma degree_le_one_implies_affine_aux_h_second_deriv_zero {n : Nat} {f : hypercube n → Bool} (hdeg : is_degree_le_bool f 1) (x h1 h2 : hypercube n) : (lift_pm1 f x) * (lift_pm1 f (xor_vec x h1)) * (lift_pm1 f (xor_vec x h2)) * (lift_pm1 f (xor_vec (xor_vec x h1) h2)) = 1 := by
  exact (degree_le_one_implies_affine_aux_h_second_deriv_zero_tail_h_anon_1 hdeg x h1 h2 ((degree_le_one_implies_affine_aux_h_anon_1 hdeg x h1 h2)))
...
lemma degree_le_one_implies_affine {f : hypercube n → Bool}
  ...
  let h_second_deriv_zero : ∀ (x h1 h2 : hypercube n), (lift_pm1 f x) * (lift_pm1 f (xor_vec x h1)) * (lift_pm1 f (xor_vec x h2)) * (lift_pm1 f (xor_vec (xor_vec x h1) h2)) = 1 := (degree_le_one_implies_affine_aux_h_second_deriv_zero hdeg)
  -- Branch on the value of f at the origin.
  by_cases h : f ( zero_vec n ) <;> simp_all +decide [ is_linear_bool , h_second_deriv_zero];
  · -- Case f(0) = true: show ¬f is linear.
    ...
    cases h : f x <;> cases h' : f y <;> simp_all +decide [h_second_deriv_zero];
    · cases h'' : f ( xor_vec x y ) <;> simp_all +decide [h_second_deriv_zero];
      unfold xor_vec at *; simp_all +decide [ zero_vec , h_second_deriv_zero] ;
    ...
    · cases h'' : f ( xor_vec x y ) <;> simp_all +decide [h_second_deriv_zero];
      ...
      norm_num at h_second_deriv_zero;
    · cases h'' : f ( xor_vec x y ) <;> simp_all +decide [ BoolToPM1 , h_second_deriv_zero];
      unfold xor_vec at *; simp_all +decide [ zero_vec , h_second_deriv_zero] ;
      norm_num at h_second_deriv_zero;
  · -- Case f(0) = false: show f is linear.
    ...
    · cases h'' : f ( xor_vec x y ) <;> simp_all +decide [h_second_deriv_zero];
      ...
      norm_num at h_second_deriv_zero;
    · unfold xor_vec at *; simp_all +decide [ zero_vec , h_second_deriv_zero] ;
      cases h'' : f ( fun i => x i ^^ y i ) <;> simp_all +decide [ BoolToPM1 , h_second_deriv_zero];
      norm_num at h_second_deriv_zero;
    · unfold xor_vec at *; simp_all +decide [ zero_vec , h_second_deriv_zero] ;
      cases h'' : f ( fun i => x i ^^ y i ) <;> simp_all +decide [ BoolToPM1 , h_second_deriv_zero];
      norm_num at h_second_deriv_zero
...
private lemma gowers_norm_eq_one_iff_aux_h_avg_lt_one__dup2 {n : Nat} (f : hypercube n → Bool) (d : Nat) (hs : Fin (d + 1) → hypercube n) (x : hypercube n) (h : gowers_product (lift_pm1 f) (d + 1) x hs ≠ 1) : (∑ x : hypercube n, ∑ hs : Fin (d + 1) → hypercube n, gowers_product (lift_pm1 f) (d + 1) x hs) < ∑ x : hypercube n, ∑ hs : Fin (d + 1) → hypercube n, 1 := by
...
private lemma gowers_norm_eq_one_iff_aux_h_avg_lt_one {n : Nat} (f : hypercube n → Bool) (d : Nat) (hs : Fin (d + 1) → hypercube n) (x : hypercube n) (h : gowers_product (lift_pm1 f) (d + 1) x hs ≠ 1) : (∑ x : hypercube n, ∑ hs : Fin (d + 1) → hypercube n, gowers_product (lift_pm1 f) (d + 1) x hs) < (2 : ℝ) ^ (n * (d + 1) + n) := by
  convert (gowers_norm_eq_one_iff_aux_h_avg_lt_one__dup2 f d hs x h) using 1 ; norm_num [ card_hypercube, card_multi_hypercube ] ; ring;

private lemma gowers_norm_eq_one_iff_tail_h_avg_lt_one {n : Nat} (f : hypercube n → Bool) (d : Nat) (hs : Fin (d + 1) → hypercube n) (x : hypercube n) (h : gowers_product (lift_pm1 f) (d + 1) x hs ≠ 1) (h_avg_lt_one : ∑ x, ∑ hs, gowers_product (lift_pm1 f) (d + 1) x hs < 2 ^ (n * (d + 1) + n)) : (expectation fun x => multi_expectation fun hs => gowers_product (lift_pm1 f) (d + 1) x hs) ≠ 1 := by
...
lemma gowers_norm_eq_one_iff (f : hypercube n → Bool) (d : ℕ) :
  ...
  · intro hs x;
    ...
    contrapose! h;
    exact (gowers_norm_eq_one_iff_tail_h_avg_lt_one f d hs x h ((gowers_norm_eq_one_iff_aux_h_avg_lt_one f d hs x h)))
...
-- ||f||_{U²}^4 = ||f * f||_2^2
private lemma gowers_U2_eq_L2_conv_aux_h_gowers_norm_pow {n : Nat} (f : BoolFun n) : gowers_norm_pow f 2 = expectation (fun x => multi_expectation (fun hs : Fin 2 → hypercube n => f x * f (xor_vec x (hs 0)) * f (xor_vec x (hs 1)) * f (xor_vec (xor_vec x (hs 1)) (hs 0)))) := by
  unfold gowers_norm_pow;
  congr! 3;
  ext hs; simp +decide [ gowers_product ] ; ring;

private lemma gowers_U2_eq_L2_conv_aux_hj {n : Nat} (f : BoolFun n) (h_gowers_norm_pow : gowers_norm_pow f 2 = expectation (fun x => multi_expectation (fun hs : Fin 2 → hypercube n => f x * f (xor_vec x (hs 0)) * f (xor_vec x (hs 1)) * f (xor_vec (xor_vec x (hs 1)) (hs 0))))) (x : hypercube n) (a₁ a₂ : Fin 2 → hypercube n) (h₁ : a₁ 0 = a₂ 0) (h₂ : xor_vec x (a₁ 1) = xor_vec x (a₂ 1)) (j : Fin n) : xor_vec x (a₁ 1) j = xor_vec x (a₂ 1) j :=
  congr_fun h₂ j

private lemma gowers_U2_eq_L2_conv_aux_h_change_vars_tail_hj {n : Nat} (f : BoolFun n) (h_gowers_norm_pow : @Eq Real (@gowers_norm_pow n f (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (@expectation n fun x => @multi_expectation n (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) fun hs => @HMul.hMul Real Real Real (@instHMul Real Real.instMul) (@HMul.hMul Real Real Real (@instHMul Real Real.instMul) (@HMul.hMul Real Real Real (@instHMul Real Real.instMul) (f x) (f (@xor_vec n x (hs (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 0) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 0))))))) (f (@xor_vec n x (hs (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 1) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 1))))))) (f (@xor_vec n (@xor_vec n x (hs (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 1) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 1))))) (hs (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 0) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 0)))))))) (x : hypercube n) (a₁ a₂ : Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) → hypercube n) (h₁ : @Eq (hypercube n) (a₁ (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 0) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 0)))) (a₂ (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 0) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 0))))) (h₂ : @Eq (hypercube n) (@xor_vec n x (a₁ (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 1) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 1))))) (@xor_vec n x (a₂ (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 1) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 1)))))) (j : Fin n) (hj : @Eq Bool (@xor_vec n x (a₁ (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 1) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 1)))) j) (@xor_vec n x (a₂ (@OfNat.ofNat (Fin (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))) (nat_lit 1) (@Fin.instOfNat (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (@Nat.instNeZeroSucc (@OfNat.ofNat Nat (nat_lit 1) (instOfNatNat (nat_lit 1)))) (nat_lit 1)))) j)) : @Eq Bool (a₁ ((fun i => i) (@Fin.mk (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (nat_lit 1) (Nat.le_refl (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))))) j) (a₂ ((fun i => i) (@Fin.mk (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2))) (nat_lit 1) (Nat.le_refl (@OfNat.ofNat Nat (nat_lit 2) (instOfNatNat (nat_lit 2)))))) j) := by
  simp only [ xor_vec ] at hj
  cases x j <;> cases a₁ 1 j <;> cases a₂ 1 j <;> simp_all +decide;

private lemma gowers_U2_eq_L2_conv_aux_h_change_vars {n : Nat} (f : BoolFun n) (h_gowers_norm_pow : gowers_norm_pow f 2 = expectation (fun x => multi_expectation (fun hs : Fin 2 → hypercube n => f x * f (xor_vec x (hs 0)) * f (xor_vec x (hs 1)) * f (xor_vec (xor_vec x (hs 1)) (hs 0))))) (x : hypercube n) : ∑ hs : Fin 2 → hypercube n, f x * f (xor_vec x (hs 0)) * f (xor_vec x (hs 1)) * f (xor_vec (xor_vec x (hs 1)) (hs 0)) = ∑ h : hypercube n, ∑ z : hypercube n, f x * f (xor_vec x h) * f z * f (xor_vec z h) := by
  rw [ ← Finset.sum_product' ];
  refine' Finset.sum_bij ( fun hs _ => ( hs 0, xor_vec x ( hs 1 ) ) ) _ _ _ _ <;> simp +decide;
  · intro a₁ a₂ h₁ h₂; funext i; fin_cases i
    · exact h₁
    · funext j
      exact (gowers_U2_eq_L2_conv_aux_h_change_vars_tail_hj f h_gowers_norm_pow x a₁ a₂ h₁ h₂ j ((gowers_U2_eq_L2_conv_aux_hj f h_gowers_norm_pow x a₁ a₂ h₁ h₂ j)))
...
lemma gowers_U2_eq_L2_conv (f : BoolFun n) :
  ...
  let h_change_vars : ∀ x : hypercube n, ∑ hs : Fin 2 → hypercube n, f x * f (xor_vec x (hs 0)) * f (xor_vec x (hs 1)) * f (xor_vec (xor_vec x (hs 1)) (hs 0)) = ∑ h : hypercube n, ∑ z : hypercube n, f x * f (xor_vec x h) * f z * f (xor_vec z h) := (gowers_U2_eq_L2_conv_aux_h_change_vars f (gowers_U2_eq_L2_conv_aux_h_gowers_norm_pow f))
  -- After the change of variables, the expression matches ‖f∗f‖₂².
  simp_all +decide [ L2_norm_sq, BoolFourier.convolution , (gowers_U2_eq_L2_conv_aux_h_gowers_norm_pow f), h_change_vars];
...
-- Pr[accept] = (1 + ||f||_{U^{d+1}}^{2^{d+1}})/2
private lemma degree_test_accept_prob_eq_aux_h_if_eq {n : Nat} (d : Nat) (f : hypercube n → Bool) (x : hypercube n) (hs : Fin (d + 1) → hypercube n) : (if gowers_product (lift_pm1 f) (d + 1) x hs = 1 then 1 else 0 : ℝ) = (1 + gowers_product (lift_pm1 f) (d + 1) x hs) / 2 := by
  split_ifs;
  · linarith;
...
lemma degree_test_accept_prob_eq (d : ℕ) (f : hypercube n → Bool) :
  ...
  simp +decide only [(degree_test_accept_prob_eq_aux_h_if_eq d f), sum_div];
...
private lemma degree_test_qualitative_soundness_aux_h_avg_lt_one {n : Nat} (d : Nat) (f : hypercube n → Bool) (hndeg : ¬is_degree_le_bool f d) : gowers_norm_pow (lift_pm1 f) (d + 1) < 1 := by
...
lemma degree_test_qualitative_soundness (d : ℕ) (f : hypercube n → Bool)
  ...
  let h_avg_lt_one : gowers_norm_pow (lift_pm1 f) (d + 1) < 1 := (degree_test_qualitative_soundness_aux_h_avg_lt_one d f hndeg)
...
private lemma char_is_degree_le_one_aux_key {n : Nat} (S : Finset (Fin n)) (a h : hypercube n) : BooleanAnalysis.chiS S a * BooleanAnalysis.chiS S (xor_vec a h) = BooleanAnalysis.chiS S h := by
  unfold BooleanAnalysis.chiS xor_vec;
  rw [ ← Finset.prod_mul_distrib ];
  apply Finset.prod_congr rfl; intro i _;
  cases a i <;> cases h i <;> simp [ BooleanAnalysis.boolToSign, Bool.xor ];

private lemma char_is_degree_le_one_aux_h1 {n : Nat} (S : Finset (Fin n)) (hs : Fin 2 → hypercube n) (x : hypercube n) (key :
    ∀ (a h : hypercube n), BooleanAnalysis.chiS S a * BooleanAnalysis.chiS S (xor_vec a h) = BooleanAnalysis.chiS S h) : BooleanAnalysis.chiS S x * BooleanAnalysis.chiS S (xor_vec x (hs 0)) = BooleanAnalysis.chiS S (hs 0) :=
  key x (hs 0)

private lemma char_is_degree_le_one_aux_h2 {n : Nat} (S : Finset (Fin n)) (hs : Fin 2 → hypercube n) (x : hypercube n) (key :
    ∀ (a h : hypercube n), BooleanAnalysis.chiS S a * BooleanAnalysis.chiS S (xor_vec a h) = BooleanAnalysis.chiS S h) (h1 : BooleanAnalysis.chiS S x * BooleanAnalysis.chiS S (xor_vec x (hs 0)) = BooleanAnalysis.chiS S (hs 0)) : BooleanAnalysis.chiS S (xor_vec x (hs 1)) * BooleanAnalysis.chiS S (xor_vec (xor_vec x (hs 1)) (hs 0)) = BooleanAnalysis.chiS S (hs 0) :=
  key (xor_vec x (hs 1)) (hs 0)

private lemma char_is_degree_le_one_aux_h3 {n : Nat} (S : Finset (Fin n)) (hs : Fin 2 → hypercube n) (x : hypercube n) : BooleanAnalysis.chiS S (hs 0) * BooleanAnalysis.chiS S (hs 0) = 1 :=
  char_S_sq n S (hs 0)
...
lemma char_is_degree_le_one (S : Finset (Fin n)) :
  ...
  calc BooleanAnalysis.chiS S x * BooleanAnalysis.chiS S (xor_vec x (hs 0)) *
      ...
      = BooleanAnalysis.chiS S (hs 0) * BooleanAnalysis.chiS S (hs 0) := by rw [ (char_is_degree_le_one_aux_h1 S hs x (char_is_degree_le_one_aux_key S)), (char_is_degree_le_one_aux_h2 S hs x (char_is_degree_le_one_aux_key S) (char_is_degree_le_one_aux_h1 S hs x (char_is_degree_le_one_aux_key S))) ]
    _ = 1 := (char_is_degree_le_one_aux_h3 S hs x)

-- The negation -χ_S also has degree ≤ 1
private lemma neg_char_is_degree_le_one_aux_h_anon_1 {n : Nat} (S : Finset (Fin n)) : is_degree_le_pm1 (char_S S) 1 :=
  char_is_degree_le_one S

private lemma neg_char_is_degree_le_one_tail_h_anon_1 {n : Nat} (S : Finset (Fin n)) (h_anon_1 : is_degree_le_pm1 (char_S S) 1) : is_degree_le_pm1 (fun x => -char_S S x) 1 := by
  simp_all +decide [ is_degree_le_pm1 ] ;

lemma neg_char_is_degree_le_one (S : Finset (Fin n)) :
    is_degree_le_pm1 (fun x => -char_S S x) 1 := by
  exact (neg_char_is_degree_le_one_tail_h_anon_1 S ((neg_char_is_degree_le_one_aux_h_anon_1 S)))

-- Characters have degree ≤ d for any d ≥ 1
private lemma char_is_degree_le_aux_h1 {n : Nat} (S : Finset (Fin n)) {d : Nat} (hd : d ≥ 1) : is_degree_le_pm1 (char_S S) 1 :=
  char_is_degree_le_one S
...
lemma char_is_degree_le (S : Finset (Fin n)) {d : ℕ} (hd : d ≥ 1) :
  ...
  | succ d ih =>
    cases d with
    | zero => exact (char_is_degree_le_aux_h1 S hd)
    | succ d => exact degree_le_succ (ih (by omega))

-- Negation of characters have degree ≤ d for any d ≥ 1
private lemma neg_char_is_degree_le_aux_h1 {n : Nat} (S : Finset (Fin n)) {d : Nat} (hd : d ≥ 1) : is_degree_le_pm1 (fun x => -char_S S x) 1 :=
  neg_char_is_degree_le_one S
...
lemma neg_char_is_degree_le (S : Finset (Fin n)) {d : ℕ} (hd : d ≥ 1) :
  ...
  | succ d ih =>
    cases d with
    | zero => exact (neg_char_is_degree_le_aux_h1 S hd)
    | succ d => exact degree_le_succ (ih (by omega))
...
-/
private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_neg_char {n d : Nat} (hd : d ≥ 1) (f : hypercube n → Bool) (ε : ℝ) (S : Finset (Fin n)) : is_degree_le_pm1 (fun x => -char_S S x) d := by
  exact neg_char_is_degree_le S hd;

private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_char__dup2 {n d : Nat} (f : hypercube n → Bool) (ε : ℝ) (S : Finset (Fin n)) (h_neg_char : is_degree_le_pm1 (fun x => -char_S S x) d) (x : BooleanAnalysis.BoolCube n) (i : Fin n) : i ∈ S → BoolToPM1 (x i) = 1 ∨ BoolToPM1 (x i) = -1 := by
  exact fun hi => by cases x i <;> tauto;

private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_char_prod {n d : Nat} (f : hypercube n → Bool) (ε : ℝ) (S : Finset (Fin n)) (h_neg_char : is_degree_le_pm1 (fun x => -char_S S x) d) (x : BooleanAnalysis.BoolCube n) {T : Finset (Fin n)} : (∀ i ∈ T, BoolToPM1 (x i) = 1 ∨ BoolToPM1 (x i) = -1) → (∏ i ∈ T, BoolToPM1 (x i)) = 1 ∨ (∏ i ∈ T, BoolToPM1 (x i)) = -1 := by
  intro hT; induction T using Finset.induction <;> simp_all +decide [ Finset.prod_insert ] ;
  grind;

private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_char {n d : Nat} (f : hypercube n → Bool) (ε : ℝ) (S : Finset (Fin n)) (h_neg_char : is_degree_le_pm1 (fun x => -char_S S x) d) (x : BooleanAnalysis.BoolCube n) : char_S S x = 1 ∨ char_S S x = -1 := by
  exact (neg_fourier_coeff_le_of_far_from_degree_aux_h_char_prod f ε S h_neg_char x) (neg_fourier_coeff_le_of_far_from_degree_aux_h_char__dup2 f ε S h_neg_char x);

private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_neg_char__dup2 {n d : Nat} (f : hypercube n → Bool) (ε : ℝ) (S : Finset (Fin n)) (h_neg_char : is_degree_le_pm1 (fun x => -char_S S x) d) : ∃ g : hypercube n → Bool, lift_pm1 g = fun x => -char_S S x := by
  use fun x => PM1ToBool? (-char_S S x) |> Option.get!;
  funext x; simp [lift_pm1, PM1ToBool?];
  -- χ_S(x) ∈ {±1}, so −χ_S(x) ∈ {∓1}, which PM1ToBool? can invert.
  cases (neg_fourier_coeff_le_of_far_from_degree_aux_h_char f ε S h_neg_char x) <;> simp +decide [ * ];
  norm_num [ BoolToPM1 ];

private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_anon_1 {n d : Nat} (hd : d ≥ 1) (f : hypercube n → Bool) (ε : ℝ) (hfar : epsilon_far_from_degree d f ε) (S : Finset (Fin n)) (g : hypercube n → Bool) (hg : is_degree_le_bool g d ∧ lift_pm1 g = fun x => -char_S S x) : bool_dist f g ≥ ε :=
  hfar.2.2 g hg.1

private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_fourier_coeff {n d : Nat} (f : hypercube n → Bool) (ε : ℝ) (S : Finset (Fin n)) (g : hypercube n → Bool) (hg : is_degree_le_bool g d ∧ lift_pm1 g = fun x => -char_S S x) : fourier_coeff (lift_pm1 f) S = -inner_product (lift_pm1 f) (lift_pm1 g) := by
  unfold fourier_coeff inner_product; simp +decide [ hg.2 ] ;
  unfold expectation; norm_num;
  ring;

private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_fourier_bound {n d : Nat} (f : hypercube n → Bool) (ε : ℝ) (S : Finset (Fin n)) (g : hypercube n → Bool) (hg : is_degree_le_bool g d ∧ lift_pm1 g = fun x => -char_S S x) (x : hypercube n) : BoolToPM1 (f x) * BoolToPM1 (g x) = 1 - 2 * (if f x = g x then 0 else 1) := by
  cases h : f x <;> cases h' : g x <;> simp_all +decide [BoolToPM1] <;> norm_num

private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_pow {n d : Nat} (f : hypercube n → Bool) (ε : ℝ) (S : Finset (Fin n)) (g : hypercube n → Bool) (hg : is_degree_le_bool g d ∧ lift_pm1 g = fun x => -char_S S x) : (1 / 2 : ℝ) ^ n * 2 ^ n = 1 := by
  rw [ ← mul_pow ]; norm_num;

private lemma neg_fourier_coeff_le_of_far_from_degree_aux_h_dist_to_fourier {n d : Nat} (f : hypercube n → Bool) (ε : ℝ) (S : Finset (Fin n)) (g : hypercube n → Bool) (hg : is_degree_le_bool g d ∧ lift_pm1 g = fun x => -char_S S x) : inner_product (lift_pm1 f) (lift_pm1 g) = 1 - 2 * bool_dist f g := by
  unfold inner_product bool_dist;
  unfold expectation lift_pm1; simp +decide [ Finset.sum_ite ] ; ring_nf;
  let h_fourier_bound : ∀ x, BoolToPM1 (f x) * BoolToPM1 (g x) = 1 - 2 * (if f x = g x then 0 else 1) := (neg_fourier_coeff_le_of_far_from_degree_aux_h_fourier_bound f ε S g hg)
  simp_all +decide [ Finset.sum_ite , h_fourier_bound] ; ring_nf;
  let h_pow : (1 / 2 : ℝ) ^ n * 2 ^ n = 1 := (neg_fourier_coeff_le_of_far_from_degree_aux_h_pow f ε S g hg)
  linarith
...
lemma neg_fourier_coeff_le_of_far_from_degree
  ...
  obtain ⟨g, hg⟩ : ∃ g : hypercube n → Bool, is_degree_le_bool g d ∧ lift_pm1 g = fun x => -char_S S x := by
    let h_neg_char : is_degree_le_pm1 (fun x => -char_S S x) d := (neg_fourier_coeff_le_of_far_from_degree_aux_h_neg_char hd f ε S)
    let h_neg_char__dup2 : ∃ g : hypercube n → Bool, lift_pm1 g = fun x => -char_S S x := (neg_fourier_coeff_le_of_far_from_degree_aux_h_neg_char__dup2 f ε S h_neg_char)
    unfold is_degree_le_bool; aesop;
  -- dist(f, g) ≥ ε since g has degree ≤ d.
  let h_anon_1 : bool_dist f g ≥ ε := (neg_fourier_coeff_le_of_far_from_degree_aux_h_anon_1 hd f ε hfar S g hg)
  -- Relate −f̂(S) to the inner product ⟨f, g⟩ (since lift(g) = −χ_S).
  let h_fourier_coeff : fourier_coeff (lift_pm1 f) S = -inner_product (lift_pm1 f) (lift_pm1 g) := (neg_fourier_coeff_le_of_far_from_degree_aux_h_fourier_coeff f ε S g hg)
  -- The inner product ⟨f, g⟩ = 1 − 2·dist(f, g).
  let h_dist_to_fourier : inner_product (lift_pm1 f) (lift_pm1 g) = 1 - 2 * bool_dist f g := (neg_fourier_coeff_le_of_far_from_degree_aux_h_dist_to_fourier f ε S g hg)
...
private lemma gowers_U2_le_of_far_aux_h_fourier_sq_le {n d : Nat} (hd : d ≥ 1) (f : hypercube n → Bool) (ε : ℝ) (hfar : epsilon_far_from_degree d f ε) : ∑ S : Finset (Fin n), (fourier_coeff (lift_pm1 f) S) ^ 4 ≤ ∑ S : Finset (Fin n), (fourier_coeff (lift_pm1 f) S) ^ 2 * (1 - 2 * ε) ^ 2 := by
...
lemma gowers_U2_le_of_far
  ...
  exact (gowers_U2_le_of_far_aux_h_fourier_sq_le hd f ε hfar).trans ( by rw [ ← Finset.sum_mul _ _ _ ] ; rw [ show ∑ S : Finset ( Fin n ), fourier_coeff ( lift_pm1 f ) S ^ 2 = 1 from parseval_pm1 f ] ; nlinarith )
...
private lemma eps_le_half_of_far_aux_h_abs_fourier_coeff {n d : Nat} (hd : d ≥ 1) (f : hypercube n → Bool) (ε : ℝ) (hfar : epsilon_far_from_degree d f ε) (S : Finset (Fin n)) : |fourier_coeff (lift_pm1 f) S| ≤ 1 - 2 * ε := by
  exact abs_fourier_coeff_le_of_far_from_degree hd f ε hfar S;
...
lemma eps_le_half_of_far
  ...
  exact absurd ( (eps_le_half_of_far_aux_h_abs_fourier_coeff hd f ε hfar) ∅ ) ( by linarith [ abs_le.mp ( (eps_le_half_of_far_aux_h_abs_fourier_coeff hd f ε hfar) ∅ ) ] )

-- Base case: ||f||_{U²}⁴ ≤ 1 - 2ε when ε-far from degree ≤ d (d ≥ 1)
private lemma gowers_norm_le_of_far_d1_aux_h1 {n d : Nat} (hd : d ≥ 1) (f : hypercube n → Bool) (ε : ℝ) (hfar : epsilon_far_from_degree d f ε) : gowers_norm_pow (lift_pm1 f) 2 ≤ (1 - 2 * ε) ^ 2 :=
  gowers_U2_le_of_far hd f ε hfar

private lemma gowers_norm_le_of_far_d1_aux_h2 {n d : Nat} (hd : d ≥ 1) (f : hypercube n → Bool) (ε : ℝ) (hfar : epsilon_far_from_degree d f ε) (h1 : gowers_norm_pow (lift_pm1 f) 2 ≤ (1 - 2 * ε) ^ 2) : ε ≤ 1 / 2 :=
  eps_le_half_of_far hd f ε hfar
...
lemma gowers_norm_le_of_far_d1
  ...
  exact le_trans (gowers_norm_le_of_far_d1_aux_h1 hd f ε hfar) (sq_one_sub_two_eps_le hfar.1 (gowers_norm_le_of_far_d1_aux_h2 hd f ε hfar (gowers_norm_le_of_far_d1_aux_h1 hd f ε hfar)))

-- ε-far from degree ≤ d implies ε-far from degree ≤ d' for d' ≤ d
private lemma epsilon_far_monotone_aux_h_deg_le {n d d' : Nat} (f : hypercube n → Bool) (ε : ℝ) (hfar : epsilon_far_from_degree d f ε) (g : hypercube n → Bool) (hg : is_degree_le_bool g d') (k : Nat) : k ≥ d' → is_degree_le_pm1 (lift_pm1 g) k := by
  exact fun hk => Nat.le_induction hg ( fun k hk ih => degree_le_succ ih ) k hk;
...
lemma epsilon_far_monotone {d d' : ℕ} (hdd : d' ≤ d)
  ...
  exact hfar.2.2 g ( (epsilon_far_monotone_aux_h_deg_le f ε hfar g hg) d hdd )
...
-/
private lemma derivative_distance_lemma_aux_h_anon_1 {n d : Nat} (_hd : GE.ge d 2) (f : BoolFourier.hypercube n → Bool) (ε : Real) (hfar :
    ∀ (δ : Real),
      GE.ge δ ε →
        Exists fun (h : BoolFourier.hypercube n) =>
          ∀ (g : BoolFourier.hypercube n → Bool),
            And (LowDegreeTest.is_degree_le_bool g (HSub.hSub d 1))
              (LT.lt
                (BoolBLR.bool_dist (fun (x : BoolFourier.hypercube n) => (f x).xor (f (BoolFourier.xor_vec x h))) g) δ)) (h : BoolFourier.hypercube n) (hh :
    ∀ (g : BoolFourier.hypercube n → Bool),
      And (LowDegreeTest.is_degree_le_bool g (HSub.hSub d 1))
        (LT.lt (BoolBLR.bool_dist (fun (x : BoolFourier.hypercube n) => (f x).xor (f (BoolFourier.xor_vec x h))) g) ε)) : And (LowDegreeTest.is_degree_le_bool (fun (x : BoolFourier.hypercube n) => ((f x).xor (f (BoolFourier.xor_vec x h))).xor Bool.true) (HSub.hSub d 1)) (LT.lt (BoolBLR.bool_dist (fun (x : BoolFourier.hypercube n) => (f x).xor (f (BoolFourier.xor_vec x h))) fun (x : BoolFourier.hypercube n) => ((f x).xor (f (BoolFourier.xor_vec x h))).xor Bool.true) ε) :=
  hh ( fun x => Bool.xor (Bool.xor (f x) (f ( xor_vec x h ))) true )

private lemma derivative_distance_lemma_tail_h_anon_1 {n d : Nat} (_hd : GE.ge d 2) (f : BoolFourier.hypercube n → Bool) (ε : Real) (hfar : ∀ (δ : Real), GE.ge δ ε → Exists fun (h : BoolFourier.hypercube n) => ∀ (g : BoolFourier.hypercube n → Bool), And (LowDegreeTest.is_degree_le_bool g (HSub.hSub d 1)) (LT.lt (BoolBLR.bool_dist (fun (x : BoolFourier.hypercube n) => (f x).xor (f (BoolFourier.xor_vec x h))) g) δ)) (h : BoolFourier.hypercube n) (hh : ∀ (g : BoolFourier.hypercube n → Bool), And (LowDegreeTest.is_degree_le_bool g (HSub.hSub d 1)) (LT.lt (BoolBLR.bool_dist (fun (x : BoolFourier.hypercube n) => (f x).xor (f (BoolFourier.xor_vec x h))) g) ε)) (h_anon_1 : And (LowDegreeTest.is_degree_le_bool (fun (x : BoolFourier.hypercube n) => ((f x).xor (f (BoolFourier.xor_vec x h))).xor Bool.true) (HSub.hSub d 1)) (LT.lt (BoolBLR.bool_dist (fun (x : BoolFourier.hypercube n) => (f x).xor (f (BoolFourier.xor_vec x h))) fun (x : BoolFourier.hypercube n) => ((f x).xor (f (BoolFourier.xor_vec x h))).xor Bool.true) ε)) : Not (And (LE.le 0 ε) (And (LE.le ε 1) (∀ (g : BoolFourier.hypercube n → Bool), LowDegreeTest.is_degree_le_bool g d → GE.ge (BoolBLR.bool_dist f g) ε))) := by
  simp_all +decide [ bool_dist ] ;
  unfold expectation at h_anon_1; norm_num at h_anon_1;
  intros; linarith;
...
lemma derivative_distance_lemma
  ...
  exact (derivative_distance_lemma_tail_h_anon_1 _hd f ε hfar h hh ((derivative_distance_lemma_aux_h_anon_1 _hd f ε hfar h hh)))
