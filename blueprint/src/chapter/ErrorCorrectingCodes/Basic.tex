...
\label{ErrorCorrectingCodes.Codeword.natCast_sub_one_nonneg_of_two_le}
\leanok
...
\label{ErrorCorrectingCodes.Codeword.one_sub_nonneg_of_le_one}
\leanok
\difficulty{2}
...
\label{ErrorCorrectingCodes.Codeword.one_sub_pos_of_le_one_sub_inv}
\leanok
