...
\begin{itemize}
  \item Singleton bound (\lean{TCSlib.CodingTheory.singleton_bound}).
  \item Exact size of Hamming balls (\lean{TCSlib.CodingTheory.hamming_ball_size}).
  \item Hamming (sphere-packing) bound (\lean{TCSlib.CodingTheory.hamming_bound}).
  \item Linear-code distance/weight characterization (\lean{TCSlib.CodingTheory.Linear_Code_dist_eq_min_weight}).
  \item Probabilistic distribution lemmas used toward GV-type bounds (\lean{TCSlib.CodingTheory.uniformity_lemma}, \lean{TCSlib.CodingTheory.prob_leq_ball_size}, \lean{TCSlib.CodingTheory.existence_bound}, \lean{TCSlib.CodingTheory.gv_bound}).
...
\lean{TCSlib.CodingTheory.Codeword}
A codeword of length $n$ over alphabet $\alpha$ is a function $c : \mathrm{Fin}\,n \to \alpha$.
\end{definition}

\begin{definition}[Pointwise operations]
\lean{TCSlib.CodingTheory.Codeword.add}
\lean{TCSlib.CodingTheory.Codeword.sub}
\lean{TCSlib.CodingTheory.Codeword.zero}
...
\lean{TCSlib.CodingTheory.Codeword.Code}
...
\lean{TCSlib.CodingTheory.Codeword.Linear_Code}
...
\lean{TCSlib.CodingTheory.Codeword.hamming_distance}
...
\lean{TCSlib.CodingTheory.Codeword.distance}
\notready
...
\lean{TCSlib.CodingTheory.Codeword.weight}
...
\lean{TCSlib.CodingTheory.Codeword.rate}
\notready
Rate is defined as
\[
...
\lean{TCSlib.CodingTheory.Codeword.max_size}
\notready
...
\lean{TCSlib.CodingTheory.dist_le_length}
\leanok
% \uses{\lean{TCSlib.CodingTheory.Codeword.distance}}
If a code $C$ has (achieved) minimum distance $d$, then $d \le n$.
\end{lemma}

\begin{theorem}[Singleton bound]
\lean{TCSlib.CodingTheory.singleton_bound}
\leanok
% \uses{\lean{TCSlib.CodingTheory.dist_le_length}}
...
\lean{TCSlib.CodingTheory.hamming_ball}
...
\lean{TCSlib.CodingTheory.hamming_ball_size}
\leanok
For any center $c$,
\[
|B_l(c)|
...
\lean{TCSlib.CodingTheory.Codeword.qaryEntropy}
Define
\[
...
\lean{TCSlib.CodingTheory.hamming_ball_size_asymptotic_upper_bound}
\notready
...
\lean{TCSlib.CodingTheory.q_pow_qary_entropy_simp}
\notready
...
\lean{TCSlib.CodingTheory.sqrt_sub_sqrt_floor_le_one}
\notready
For $x\ge 0$,
\[
...
\lean{TCSlib.CodingTheory.binomial_coef_asymptotic_lower_bound'}
\notready
...
\lean{TCSlib.CodingTheory.hamming_ball_non_intersect}
\leanok
...
\lean{TCSlib.CodingTheory.hamming_ball'_disjoint}
\leanok
A \lean{Finset.Disjoint} reformulation of the previous lemma.
\end{lemma}

\begin{theorem}[Hamming (sphere-packing) bound]
\lean{TCSlib.CodingTheory.hamming_bound}
\leanok
% \uses{\lean{TCSlib.CodingTheory.hamming_ball_size}, \lean{TCSlib.CodingTheory.hamming_ball'_disjoint}}
...
\lean{TCSlib.CodingTheory.Linear_Code_dist_eq_min_weight}
\leanok
% \uses{\lean{TCSlib.CodingTheory.Codeword.Linear_Code'}, \lean{TCSlib.CodingTheory.Codeword.weight}, \lean{TCSlib.CodingTheory.Codeword.distance}}
...
\lean{TCSlib.CodingTheory.prob_leq_ball_size}
\notready
...
\lean{TCSlib.CodingTheory.existence_bound}
\notready
...
\lean{TCSlib.CodingTheory.gv_bound}
\notready
...
\lean{TCSlib.CodingTheory.list_decodable}
...
\lean{TCSlib.CodingTheory.qary_entropy_pos}
\leanok
...
\lean{TCSlib.CodingTheory.list_decoding_capacity}
\leanok
