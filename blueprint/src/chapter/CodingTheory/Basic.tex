...
\begin{itemize}
  \item Singleton bound (\lean{TCSlib.CodingTheory.Basic.singleton_bound}).
  \item Exact size of Hamming balls (\lean{TCSlib.CodingTheory.Basic.hamming_ball_size}).
  \item Hamming (sphere-packing) bound (\lean{TCSlib.CodingTheory.Basic.hamming_bound}).
  \item Linear-code distance/weight characterization (\lean{TCSlib.CodingTheory.Basic.Linear_Code_dist_eq_min_weight}).
  \item Probabilistic distribution lemmas used toward GV-type bounds (\lean{TCSlib.CodingTheory.Basic.uniformity_lemma}, \lean{TCSlib.CodingTheory.Basic.prob_leq_ball_size}, \lean{TCSlib.CodingTheory.Basic.existence_bound}, \lean{TCSlib.CodingTheory.Basic.gv_bound}).
...
\lean{TCSlib.CodingTheory.Basic.Codeword}
A codeword of length $n$ over alphabet $\alpha$ is a function $c : \mathrm{Fin}\,n \to \alpha$.
\end{definition}

\begin{definition}[Pointwise operations]
\lean{TCSlib.CodingTheory.Basic.Codeword.add}
\lean{TCSlib.CodingTheory.Basic.Codeword.sub}
\lean{TCSlib.CodingTheory.Basic.Codeword.zero}
...
\lean{TCSlib.CodingTheory.Basic.Codeword.Code}
...
\lean{TCSlib.CodingTheory.Basic.Codeword.Linear_Code}
...
\lean{TCSlib.CodingTheory.Basic.Codeword.hamming_distance}
...
\lean{TCSlib.CodingTheory.Basic.Codeword.distance}
\notready
...
\lean{TCSlib.CodingTheory.Basic.Codeword.weight}
...
\lean{TCSlib.CodingTheory.Basic.Codeword.rate}
\notready
Rate is defined as
\[
...
\lean{TCSlib.CodingTheory.Basic.Codeword.max_size}
\notready
\lean{max_size n d A} asserts existence of a code of size $A$ and minimum distance $d$ that is maximal among all such codes.
\end{definition}
...
\lean{TCSlib.CodingTheory.Basic.dist_le_length}
\leanok
% \uses{\lean{TCSlib.CodingTheory.Basic.Codeword.distance}}
If a code $C$ has (achieved) minimum distance $d$, then $d \le n$.
\end{lemma}

\begin{theorem}[Singleton bound]
\lean{TCSlib.CodingTheory.Basic.singleton_bound}
\leanok
% \uses{\lean{TCSlib.CodingTheory.Basic.dist_le_length}}
...
\lean{TCSlib.CodingTheory.Basic.hamming_ball}
...
\lean{TCSlib.CodingTheory.Basic.hamming_ball_size}
\leanok
For any center $c$,
\[
|B_l(c)|
...
\lean{TCSlib.CodingTheory.Basic.Codeword.qaryEntropy}
Define
\[
...
\lean{TCSlib.CodingTheory.Basic.hamming_ball_size_asymptotic_upper_bound}
\notready
...
\lean{TCSlib.CodingTheory.Basic.q_pow_qary_entropy_simp}
\notready
...
\lean{TCSlib.CodingTheory.Basic.sqrt_sub_sqrt_floor_le_one}
\notready
For $x\ge 0$,
\[
...
\lean{TCSlib.CodingTheory.Basic.binomial_coef_asymptotic_lower_bound'}
\notready
...
\lean{TCSlib.CodingTheory.Basic.hamming_ball_non_intersect}
\leanok
...
\begin{lemma}[Disjointness of hamming balls]
\lean{TCSlib.CodingTheory.Basic.hamming_ball'_disjoint}
\leanok
A \lean{Finset.Disjoint} reformulation of the previous lemma.
\end{lemma}

\begin{theorem}[Hamming (sphere-packing) bound]
\lean{TCSlib.CodingTheory.Basic.hamming_bound}
\leanok
% \uses{\lean{TCSlib.CodingTheory.Basic.hamming_ball_size}, \lean{TCSlib.CodingTheory.Basic.hamming_ball'_disjoint}}
...
\lean{TCSlib.CodingTheory.Basic.Linear_Code_dist_eq_min_weight}
\leanok
% \uses{\lean{TCSlib.CodingTheory.Basic.Codeword.Linear_Code'}, \lean{TCSlib.CodingTheory.Basic.Codeword.weight}, \lean{TCSlib.CodingTheory.Basic.Codeword.distance}}
...
\lean{TCSlib.CodingTheory.Basic.prob_leq_ball_size}
\notready
...
\lean{TCSlib.CodingTheory.Basic.existence_bound}
\notready
...
\lean{TCSlib.CodingTheory.Basic.gv_bound}
\notready
...
\lean{TCSlib.CodingTheory.Basic.list_decodable}
...
\lean{TCSlib.CodingTheory.Basic.qary_entropy_pos}
\leanok
...
\lean{TCSlib.CodingTheory.Basic.list_decoding_capacity}
\leanok
